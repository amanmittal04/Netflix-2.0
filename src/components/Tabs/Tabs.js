                ...
                <div className='container'>
                    <div id='tab-1-content' className={`tab-content-item ${activeTabName === CANCEL_AT_ANY_TIME && "show" }`}>
                        <div className='tab-1-content-inner'>
                            <div>
                                <p className='text-lg'>
                                    If you decide Netflix isn't for you - No Problem. No commitment. Cancel At Any Time.
                                </p>
                        ...
                        <div className='tab-2-content-bottom'>
                            <div>
                                ...
                                <p className='text-dark'>
                                    Smart TVs, PlayStatiuon, Xbox, Chromecast, Apple TV, Blu-ray players and more
                                </p>
                            </div>
                            <div>
                ...
                <div className='container'>
                    <div id='tab-3-content' className={`tab-content-item ${activeTabName === PICK_YOUR_PRICE  && "show" }`}>
                        ...
                        <table className='table'>
                            ...
                            <tbody>
                                <tr>
                                    <td>Monthly Price after free months ends on 25/04/22</td>
                                    <td>$6.99</td>
                                    <td>$11.99</td>
                                    <td>$15.99</td>
                                </tr>
